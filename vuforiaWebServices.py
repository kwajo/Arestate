...
'''
THis CODE TAKES A FILE FROM A BUCKET WITH THE CORRECT KEY AND RETURNS THE IMAGE
AS AN IO STREAM
...
def main():
    ...
    v = Vuforia(access_key="242dd551345f4d98ca1307aeab570cd81da4bd8f",
                secret_key="77473af8d46b31e79ca885151cf9faae3f2faa15")
    for target in v.get_targets():
        print target

    #image_file = open('/home/kwajo/Desktop/sale1')
#    image = base64.b64encode(image_file.read())
    image = base64.b64encode(read_s3_contents_with_download('areestatevideos','sale1'))

    #ThiS code Adds a target to firebase

    #metadata_file = open('PATH_TO_METADATAFILE')
#    metadata = base64.b64encode(metadata_file.read())
    print v.add_target({"name": "zxczxc", "width": float(320),"image": image,  "active_flag": 1})  #"application_metadata": metadata,
...
#access key 242dd551345f4d98ca1307aeab570cd81da4bd8f

#secret key  77473af8d46b31e79ca885151cf9faae3f2faa15
